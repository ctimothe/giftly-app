...
2. Add Environment Variables:
   ...
   - `GOOGLE_CLIENT_ID`: Google OAuth client ID (optional but recommended)
   - `PORT`: `5001` (or leave empty if Railway assigns one automatically, usually they set `PORT`)
...
2. Add Environment Variables:
   ...
   - `VITE_GOOGLE_CLIENT_ID`: same Google OAuth client ID used on backend
